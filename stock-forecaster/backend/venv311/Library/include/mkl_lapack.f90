...
INTERFACE GELST
        ! TRANS='N','T'; default: 'N'
    PURE SUBROUTINE SGELST_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ...
        REAL(WP), INTENT(INOUT) :: A(:,:)
        REAL(WP), INTENT(INOUT) :: B(:,:)
    END SUBROUTINE SGELST_F95
    PURE SUBROUTINE SGELST1_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ! SGELST(TRANS,M,N,NRHS,A,LDA,B,LDB,WORK,LWORK,INFO)
        USE F95_PRECISION, ONLY: WP => SP
        CHARACTER(LEN=1), INTENT(IN), OPTIONAL :: TRANS
        ...
        REAL(WP), INTENT(INOUT) :: A(:,:)
        REAL(WP), INTENT(INOUT) :: B(:)
    END SUBROUTINE SGELST1_F95
    PURE SUBROUTINE DGELST_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ...
        REAL(WP), INTENT(INOUT) :: A(:,:)
        REAL(WP), INTENT(INOUT) :: B(:,:)
    END SUBROUTINE DGELST_F95
    PURE SUBROUTINE DGELST1_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ! DGELST(TRANS,M,N,NRHS,A,LDA,B,LDB,WORK,LWORK,INFO)
        USE F95_PRECISION, ONLY: WP => DP
        CHARACTER(LEN=1), INTENT(IN), OPTIONAL :: TRANS
        ...
        REAL(WP), INTENT(INOUT) :: A(:,:)
        REAL(WP), INTENT(INOUT) :: B(:)
    END SUBROUTINE DGELST1_F95
    PURE SUBROUTINE CGELST_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ...
        COMPLEX(WP), INTENT(INOUT) :: A(:,:)
        COMPLEX(WP), INTENT(INOUT) :: B(:,:)
    END SUBROUTINE CGELST_F95
    PURE SUBROUTINE CGELST1_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ! CGELST(TRANS,M,N,NRHS,A,LDA,B,LDB,WORK,LWORK,INFO)
        USE F95_PRECISION, ONLY: WP => SP
        CHARACTER(LEN=1), INTENT(IN), OPTIONAL :: TRANS
        ...
        COMPLEX(WP), INTENT(INOUT) :: A(:,:)
        COMPLEX(WP), INTENT(INOUT) :: B(:)
    END SUBROUTINE CGELST1_F95
    PURE SUBROUTINE ZGELST_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ...
        COMPLEX(WP), INTENT(INOUT) :: A(:,:)
        COMPLEX(WP), INTENT(INOUT) :: B(:,:)
    END SUBROUTINE ZGELST_F95
    PURE SUBROUTINE ZGELST1_F95(A,B,TRANS,INFO)
        ! Fortran77 call:
        ! ZGELST(TRANS,M,N,NRHS,A,LDA,B,LDB,WORK,LWORK,INFO)
        USE F95_PRECISION, ONLY: WP => DP
        CHARACTER(LEN=1), INTENT(IN), OPTIONAL :: TRANS
