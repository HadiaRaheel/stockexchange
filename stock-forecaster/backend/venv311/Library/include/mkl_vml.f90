...
!  Scaled complementary Error Function: r[i] = r[i] = exp(a[i]^2)*erfc(a[i])

      INTERFACE
        SUBROUTINE vserfcx(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vserfcxi(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vderfcxi(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmserfcx(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmserfcxi(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmderfcx(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmderfcxi(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Regular modified cylindrical Bessel function of order 0: r[i] = i0(a[i])

      INTERFACE
        SUBROUTINE vsi0(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsi0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdi0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsi0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Regular modified cylindrical Bessel function of order 1: r[i] = i1(a[i])

      INTERFACE
        SUBROUTINE vsi1(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsi1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdi1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsi1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!    Bessel function of the first kind of order 0: r[i] = j0(a[i])

      INTERFACE
        SUBROUTINE vsj0(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsj0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdj0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsj0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Bessel function of the first kind of order 1: r[i] = j1(a[i])

      INTERFACE
        SUBROUTINE vsj1(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsj1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdj1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsj1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!    Bessel function of the second kind of order 0: r[i] = y0(a[i])

      INTERFACE
        SUBROUTINE vsy0(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsy0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdy0i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsy0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy0i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Bessel function of the second kind of order 1: r[i] = y1(a[i])

      INTERFACE
        SUBROUTINE vsy1(n,a,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vsy1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdy1i(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsy1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy1i(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!  Bessel function of the first kind of order b: r[i] = jn(a[i],b)

      INTERFACE
        SUBROUTINE vsjn(n,a,b,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vsjni(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vdjni(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsjni(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdjni(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
...
!  Bessel function of the second kind of order b: r[i] = yn(a[i],b)

      INTERFACE
        SUBROUTINE vsyn(n,a,b,r)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vsyni(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vdyni(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsyni(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdyni(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
...
!  Scaled complementary Error Function: r[i] = exp(a[i]^2)*erfc(a[i])

      INTERFACE
        SUBROUTINE vserfcx_64(n,a,r)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
        END SUBROUTINE
      ...
      INTERFACE
        SUBROUTINE vserfcxi_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vderfcxi_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmserfcx_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmserfcxi_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmderfcx_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmderfcxi_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!  Regular modified cylindrical Bessel function of order 0: r[i] = i0(a[i])
      ...
      INTERFACE
        SUBROUTINE vsi0i_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdi0i_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsi0_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsi0i_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi0_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi0i_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!  Regular modified cylindrical Bessel function of order 1: r[i] = i1(a[i])
      ...
      INTERFACE
        SUBROUTINE vsi1i_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdi1i_64(n,a,inca,r,incr)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsi1_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsi1i_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi1_64(n,a,r,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdi1i_64(n,a,inca,r,incr,mode)
          INTEGER(KIND=8),INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!    Bessel function of the first kind of order 0: r[i] = j0(a[i])
      ...
      INTERFACE
        SUBROUTINE vsj0i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdj0i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsj0_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsj0i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj0_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj0i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Bessel function of the first kind of order 1: r[i] = j1(a[i])
      ...
      INTERFACE
        SUBROUTINE vsj1i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdj1i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsj1_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsj1i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj1_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdj1i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!    Bessel function of the second kind of order 0: r[i] = y0(a[i])
      ...
      INTERFACE
        SUBROUTINE vsy0i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdy0i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsy0_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsy0i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy0_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy0i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!   Bessel function of the second kind of order 1: r[i] = y1(a[i])
      ...
      INTERFACE
        SUBROUTINE vsy1i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vdy1i_64(n,a,inca,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER,INTENT(IN) :: inca
      ...
      INTERFACE
        SUBROUTINE vmsy1_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmsy1i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy1_64(n,a,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
      ...
      INTERFACE
        SUBROUTINE vmdy1i_64(n,a,inca,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
          INTEGER(KIND=8),INTENT(IN) :: mode
...
!  Bessel function of the first kind of order b: r[i] = jn(a[i],b)
      ...
      INTERFACE
        SUBROUTINE vsjni_64(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vdjni_64(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsjn_64(n,a,b,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsjni_64(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdjn_64(n,a,b,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdjni_64(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
...
!  Bessel function of the second kind of order b: r[i] = yn(a[i],b)
      ...
      INTERFACE
        SUBROUTINE vsyni_64(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vdyni_64(n,a,inca,b,r,incr)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsyn_64(n,a,b,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmsyni_64(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=4),INTENT(IN)    :: b
          REAL(KIND=4),INTENT(IN)    :: a(n)
          REAL(KIND=4),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdyn_64(n,a,b,r,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
      ...
      INTERFACE
        SUBROUTINE vmdyni_64(n,a,inca,b,r,incr,mode)
          INTEGER,INTENT(IN) :: n
          REAL(KIND=8),INTENT(IN)    :: b
          REAL(KIND=8),INTENT(IN)    :: a(n)
          REAL(KIND=8),INTENT(OUT)   :: r(n)
